//#include "Block.h"
//
//BlockMicho::BlockMicho(const json& JSON) {
//	this->JSON = JSON;
//	transformData();
//};
//
//void BlockMicho::transformData() {
...
//inline const std::string BlockMicho::hexCodedASCII(unsigned int number) {
//	char res[9];
...
//}
//
//inline const std::string BlockMicho::hash(const std::string& code) {
//	return hexCodedASCII(generateID((unsigned char*)code.c_str()));
//}
//
//void BlockMicho::buildTree(void) 
//{
...
//}
//
//const std::string BlockMicho::getData(const BlockInfo& data) {
//	switch (data) {
